...
const getLocalAppDataPath = (path) => {
    const userRegExp = /\/mnt\/([a-z])\/Users\/([^/:]+)\/AppData\//;
    const results = userRegExp.exec(path) || [];
    return `/mnt/${results[1]}/Users/${results[2]}/AppData/Local`;
};
const wsl = (browser) => {
    environment_1.setVariable('LOCALAPPDATA', getLocalAppDataPath(`${environment_1.getVariable('PATH')}`));
    environment_1.setVariable('PROGRAMFILES', '/mnt/c/Program Files');
    environment_1.setVariable('PROGRAMFILES(X86)', '/mnt/c/Program Files (x86)');
