...
const notifyIfNeeded = () => {
    const pkg = load_hint_package_1.default();
    ...
    const message = `Update available ${chalk_1.default.red(update.current)}${chalk_1.default.reset(' → ')}${chalk_1.default.green(update.latest)}\
