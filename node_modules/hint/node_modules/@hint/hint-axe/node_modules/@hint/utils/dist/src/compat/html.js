...
exports.getAttributeUnsupported = (feature, browsers) => {
    ...
    return cache_1.getCachedValue(key, browsers, () => {
        ...
        if (feature.element) {
            ...
            [data, prefix] = helpers_1.getFeatureData(elementData, feature.attribute);
        }
        if (!data) {
            [data, prefix] = helpers_1.getFeatureData(browser_compat_data_1.mdn.html.global_attributes, feature.attribute);
        }
        if (feature.value) {
            [data, prefix] = helpers_1.getFeatureData(data, feature.value);
        }
...
exports.getElementUnsupported = (feature, browsers) => {
    return cache_1.getCachedValue(`html-element:${feature.element}`, browsers, () => {
        const [data, prefix] = helpers_1.getFeatureData(browser_compat_data_1.mdn.html.elements, feature.element);
        return browsers_1.getUnsupportedBrowsers(data, prefix, browsers);
    });
};
